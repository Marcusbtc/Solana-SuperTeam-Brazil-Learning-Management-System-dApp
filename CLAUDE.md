...
**Docs**:
- `onchain-academy/docs/SPEC.md` — Canonical program specification (source of truth)
- `onchain-academy/docs/ARCHITECTURE.md` — Account maps, data flows, CU budgets
- `onchain-academy/docs/INTEGRATION.md` — Frontend integration guide (PDA derivation, instruction usage, events)
...
│   └── docs/                    ← Program docs and integration guides
...
See `onchain-academy/docs/SPEC.md` for full specification and `onchain-academy/docs/INTEGRATION.md` for frontend usage.
...
./onchain-academy/scripts/update-program-id.sh
...
**Docs**: `onchain-academy/docs/` | **Skills**: `.claude/skills/` | **Rules**: `.claude/rules/` | **Commands**: `.claude/commands/` | **Agents**: `.claude/agents/`
